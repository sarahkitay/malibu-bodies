    ...
    <>
      <motion.button
        ...
        className={cn(
          ...
          isMobile ? "bottom-[calc(7.5rem+env(safe-area-inset-bottom))] right-4" : "bottom-6 right-6"
        )}
          ...
          <>
            ...
            <motion.div
              ...
              className={cn(
                ...
                isMobile ? "bottom-[calc(11.5rem+env(safe-area-inset-bottom))] right-4" : "bottom-24 right-6"
              )}
            >
